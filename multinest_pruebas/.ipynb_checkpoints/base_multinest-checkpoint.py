...
# run MultiNest
pymultinest.run(loglike, prior, n_params, outputfiles_basename='/Users/juda/lab_alma/multinest_pruebas/chain_base/',
	resume = False, verbose = True)
json.dump(parameters, open('/Users/juda/lab_alma/multinest_pruebas/chain_base/params.json', 'w')) # save parameter names
