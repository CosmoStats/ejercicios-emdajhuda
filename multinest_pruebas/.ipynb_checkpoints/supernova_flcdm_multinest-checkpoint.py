...
pymultinest.run(
    ...
    prior,
    n_params,
    outputfiles_basename='/Users/juda/lab_alma/multinest_pruebas/chain_supernova_flcdm/',
    resume=False,
    verbose=True,
    n_live_points=2000
)
...
json.dump(
    parameters,
    open(
        '/Users/juda/lab_alma/multinest_pruebas/chain_supernova_flcdm/params.json',
        'w'
    )
)